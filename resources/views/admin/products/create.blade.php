    ...
    <main class="main">
        <header class="topbar">
            <div class="top-left">
                ...
                <div class="page-title">
                    <h1>Tambah Produk</h1>
                    <p>Buat produk investasi baru dan atur harga, profit, durasi, serta minimal VIP.</p>
                </div>
            </div>
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <h2>Tambahkan produk baru dengan struktur yang lebih rapi.</h2>

                <p>
                    Pastikan kategori, harga, keuntungan harian, durasi, dan minimal VIP sudah sesuai
                    supaya produk tampil benar di halaman investasi user.
                </p>
        ...
        <section class="content-grid">
            <div class="panel">
                <div class="panel-head">
                    <div class="panel-title">
                        ...
                        <span>Lengkapi detail produk investasi baru.</span>
                    </div>
                </div>
            ...
            <aside class="side-stack">
                        ...
                        <div class="quick-list">
                            ...
                            <a class="quick-card" href="/admin/deposits">
                                <div class="quick-left">
                                    ...
                                    <div>
                                        <b>Deposits</b>
                                        <span>Cek riwayat isi saldo.</span>
                                    </div>
                                </div>
                                <div class="quick-arrow">→</div>
                            </a>
                ...
                <div class="warning-box">
                    Total profit akan dihitung otomatis dari <b>untung harian × durasi</b> melalui controller yang sudah bro punya.
                </div>
                ...
                <div class="panel">
                    <div class="panel-head">
                        <div class="panel-title">
                            <b>Catatan</b>
                            <span>Tips pengisian produk.</span>
                        </div>
                    </div>

                    <div class="panel-inner note-box">
                        Gunakan nama produk yang konsisten, misalnya berdasarkan kategori dan level.
                        Minimal VIP sebaiknya mengikuti aturan benefit agar user tidak bisa membeli produk di luar levelnya.
                    </div>
                </div>
            </aside>
        </section>
